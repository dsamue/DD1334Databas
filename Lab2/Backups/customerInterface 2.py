...
class DBContext:
    ...
    def shipments(self):
        ...
        # query ="SELECT shipments.isbn, shipments.customer_id FROM shipments, customers WHERE shipments.customer_id = 107 AND shipments.customer_id = customers.customer_id AND first_name = 'Annie' AND last_name = 'Jackson';"
        print query
        ...
        query ="SELECT shipments.isbn, shipments.customer_id FROM shipments, customers WHERE shipments.customer_id = '%i' AND shipments.customer_id = customers.customer_id AND first_name = '%s' AND last_name = '%s';"%(ID,fname,lname)
